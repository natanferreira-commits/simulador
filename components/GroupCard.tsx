...
export function GroupCard({
  ...
  return (
    <section className="mb-10">
      <h2 className="text-2xl font-extrabold text-zinc-900 mb-3 tracking-tight">
        GRUPO {groupLetter}
      </h2>
      <div className="grid lg:grid-cols-[1fr_300px] gap-8 items-start border-t border-zinc-200 pt-1">
        {/* Standings */}
        <div>
        ...
        <div className="lg:border-l lg:border-zinc-100 lg:pl-6">
          <div className="flex items-center justify-between mb-1 py-2 border-b border-zinc-100">
            <button
              onClick={() => setRound((r) => (r > 1 ? ((r - 1) as 1 | 2 | 3) : 1))}
              disabled={round === 1}
              className="w-6 h-6 flex items-center justify-center text-zinc-400 hover:text-zinc-900 disabled:opacity-20 disabled:cursor-not-allowed transition"
